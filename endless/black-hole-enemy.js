(() => {
  ...
  const rendererDpr = Math.min(1.35, window.devicePixelRatio || 1);
  const rendererSize = Math.max(448, Math.min(544, Math.ceil(MAX_GAME_BOSS_DIAMETER * RENDER_FRAME_PADDING * rendererDpr / 16) * 16));
