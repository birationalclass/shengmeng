...
assert(/SUPPORT_OVERHEAL_CHANCES = \[0,\.02,\.04,\.06,\.08,\.10\]/.test(gameSource)&&/SUPPORT_OVERHEAL_RATES = \[\.01,\.012,\.014,\.016,\.018,\.02\]/.test(gameSource)&&/Math\.ceil\(treatment\*SUPPORT_OVERHEAL_RATES\[rank\]\)/.test(gameSource),"治疗筑垒按每次治疗判定，触发概率成长至 10%，转化率由 1% 成长至 2%");
