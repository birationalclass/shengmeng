...
- 合并后的正文黑板也必须写出简短讲解：交代公式的对象、条件或推理目的，不能只剩标题和公式。`chalk-language.js` 与 `flow-explanation.js` 按实际字体将说明排在相应公式后；密集英文板书可用 `board-explanations.js` 的人工短稿，完整说明仍保留在高清阅读层。正文保持白色粉笔，彩色只用于必要的局部定义标记。
...
报告人顺序为胡勇、段治豪（Zhihao Duan）、叶东、孟晟，开场默认胡勇。Zhihao Duan 的报告依据 Chen–Duan–Jia–Lee 的 [arXiv:2609.12750v1](https://arxiv.org/abs/2609.12750)，2026-09-11 提交。2026-09-22 按 INSPIRE 作者标识 `Z.Duan.2`（作者页 1695597）以最新日期排序核对，为其最新 arXiv 成果；中文姓名按本人网站维护者提供的信息使用“段治豪”；英文保留 Zhihao Duan。
...
## 胡勇报告的逐行重编（2026-09-24）

根据 Du–Hu, arXiv:2606.31170v1 §§1–3，正文由 24 页重编为 30 页，另有标题和结束页。`hu-board-content.mjs` 明确编写每页 6 条语义内容，按文字与公式的实际讲授顺序排列；图示页单独安排。新增 243 的计算、典范直像丛的 Riemann–Roch、满秩次数分解、大/小零除子的完整分支及消失传播的几何解释。英文采用用户选定的 Marck Script，公式字体不变。

来源审校说明见 `assets/chalk/hu/SOURCES.md`。其他三份报告和 KM 的数学内容本次不作同等深度重编。
