...
export function recommendedGraphics({mobile=false,gpu='',maxTextureSize=4096}={}){
 ...
 return {...GRAPHICS_PRESETS[high?'high':'balanced'],resolutionScale:'100',oceanModel:'auto',targetFPS:'60',adaptiveQuality:'auto',rainEffects:'on',starEffects:mobile?'off':'on',geometryDetail:'auto',windWaves:'on',waveStrength:'50',sunReflection:'on'};
}
