...
- Vegetation farther than 60 world units from the original building origin uses 20-face rather than 80-face leaf clusters and skips foliage shadow casting. This is fixed site-distance detail selection, not a dynamic camera LoD system. Near foliage retains the original geometry. Scene-assembly triangles fall from 1,509,512 to 892,988 (about 41%) despite the added close-range details; GPU frame rate and memory have not been measured on phones.
