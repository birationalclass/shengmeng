...
test('speaker view remains manual through idle time and exits only on explicit camera selection',async()=>{
  ...
  const context=vm.createContext({cameraLocked:()=>false,sunriseIntro:{waiting:false},SHOTS,buildingForShot,setSeminarPanel(){},keys:new Set(['w']),reader:{close(){}},boardFollow:{reset(){}},beginTransition(){},updateLabels(){},opening:{},choosingReport:true,speakerView:false,touring:true,free:false});
