...
import {SudokuAtlas,REGIONS} from './atlas.mjs?v=ecnu-blue2';
import {cameraKey} from './camera-navigation.mjs?v=ecnu-blue2';
import {THEMES} from './journey.mjs?v=ecnu-blue2';
