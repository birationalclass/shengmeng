...
import {SudokuAtlas,REGIONS} from './atlas.mjs?v=pool-fireworks1';
import {cameraKey} from './camera-navigation.mjs?v=pool-fireworks1';
import {THEMES} from './journey.mjs?v=pool-fireworks1';
