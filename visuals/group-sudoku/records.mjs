...
export function createCompletionRecords({campaign,t,onOpen=()=>{}}){
 ...
 function sync(){
  ...
  text($('recordsTitle'),'通关记录','Completion records');text($('recordsIntro'),'全员可查看。记录保存于服务器，学号部分隐藏。','Visible to everyone. Records are saved on the server; student IDs are partially hidden.');text($('recordsRefresh'),'刷新','Refresh');text($('recordsRegister'),'登记本次通关','Register completion');$('recordsRegister').disabled=!ready();
