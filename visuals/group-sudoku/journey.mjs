...
export function arrivalPhase(t,wasBuilt=false,seconds=15){return t<2.8?'moving':wasBuilt?'ready':t<3?'settled':t<3+seconds+.15?'building':t<3+seconds+1.35?'board':'ready';}
