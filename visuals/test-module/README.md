...
Exterior drive gears now sit on cantilevered metal trays outside each masonry platform, with bearing collars and axle caps. Archive/server decorative gears that intersected columns or cabinets were removed. Central Newton, cathedral and pagoda drive layers have separate vertical clearance from the plinths above; the cathedral staircase is routed beyond the rotating gear radius. Bridge drive wheels sit outside the stone pier footprint on supported trays.
