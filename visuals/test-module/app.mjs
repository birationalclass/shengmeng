import {setupMusic} from './music.mjs?v=20260920h';
...
let music;let after=0;let scene,t=prefs.reduced?18:0,playing=!prefs.reduced,last=0,phase=null,captionTimer,frame=0,failed=false,dirty=true;
...
function setPlaying(value){playing=value&&!failed;$('play').textContent=playing?'Ⅱ':'▷';$('play').setAttribute('aria-label',playing?'暂停动画':'播放动画');$('cinema').dataset.playing=String(playing);last=0;music?.sync();}
