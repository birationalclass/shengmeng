...
export function setupMusic({getPlaying,getTime}){
 ...
 async function sync(){audio.muted=testMuted||!enabled;if(enabled&&getPlaying()&&!testMuted){try{await audio.play();}catch{status.textContent='点击“开启背景音乐”以允许播放。';}}else audio.pause();}
