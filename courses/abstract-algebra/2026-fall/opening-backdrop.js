...
(() => {
  ...
  const scenes = [
    ...
    {logo:'ℂ',title:'Julia 分形',kind:'julia-verse',zh:'上帝的指纹\n迭代的艺术',en:'God’s Fingerprint\nThe Art of Iteration'},
    {logo:'ℤ',title:'THE LORD OF THE RINGS',zh:'整数环是含幺环的起点：到每个含幺环，都有唯一的保幺环同态。',en:'From ℤ to every unital ring, there is a unique unital homomorphism.',kind:'ring-verse',verse:{en:'One Ring to rule them all,\nOne Ring to find them,\nOne Ring to bring them all,\nand in the darkness bind them.',zh:'一戒统御众戒，\n一戒寻觅众戒，\n一戒召集众戒，\n禁锢众戒黑暗中'}},
