...
(()=>{
  ...
  function labels(){
    ...
    $('portal-fullscreen').hidden=view!=='lesson'||phone.matches;$('portal-fullscreen').textContent=document.fullscreenElement?t('退出全屏','Exit fullscreen'):t('全屏授课','Fullscreen');
