...
for(const file of ['lesson-groups/content.js','lesson-groups/chapter-two.js','lesson-groups/exercises.js','lesson-groups/textbook-references.js','lesson-groups/chapter-three.js','lesson-groups/chapter-four.js','lesson-groups/ring-exercises.js','lesson-1/notebook-content.js','lesson-1/exercises.js'])vm.runInContext(fs.readFileSync(path.join(root,file),'utf8'),context);
