...
const groups={
 'learn:3':{section:2,first:5,items:[[1],[2]]},
 ...
 'converge:0':{section:2,first:3,items:[[1],[2,3,4]]},
 'converge:1':{section:2,first:9,items:[[1]]},
 'converge:2':{section:2,first:10,items:[[1,2]]},
 'converge:3':{section:2,first:11,items:[[1],[2],[3],[4]]}
};
...
const titles={
 ...
 'converge:0':[['自然过渡映射','Natural transition map'],['命题：逐位置稳定','Proposition: Pointwise stabilization']],
