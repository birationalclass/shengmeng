...
const groups={
 ...
 'learn:6':{section:2,first:3,items:[[1],[2]]},
 'learn:4':{section:2,first:5,items:[[1],[2,3]]},
 'learn:5':{section:2,first:7,items:[[3],[4]],actions:[[1,2,3],[4]],focus:[3,4]},
 'converge:0':{section:2,first:9,items:[[1,2,3]]},
 'converge:1':{section:2,first:10,items:[[1]]},
 'converge:2':{section:2,first:11,items:[[1,2]]},
 'converge:3':{section:2,first:12,items:[[1]]}
};
