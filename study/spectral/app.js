import {leraySetup} from './leray.js?v=124';
...
import {createAbutmentView} from './abutment-view.js?v=124';
...
import {numberedPages} from './reading-pages.js?v=124';
...
import {lessons,convergence,initial,totalCohomology} from './content.js?v=124';
...
const formulas=(fs,concepts=[],number='',module='',step=0)=>numberedPages(module,step,fs.length).map((page,index)=>{
 ...
 const content=page.indices.map(i=>{
  ...
  if(module==='converge'&&step===4&&i===1)return leraySetup({math,t:ui})+formula;
