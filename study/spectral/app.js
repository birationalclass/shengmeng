import {leraySetup} from './leray.js?v=137';
import {createDifferentialSweep} from './differential-sweep.js?v=120';
import {filteredSubcomplexExposition} from './filtered-subcomplex.js?v=137';
...
import {createStabilityView} from './stability-view.js?v=137';
import {installReadingTouch} from './reading-touch.js?v=74';
import {createAbutmentView} from './abutment-view.js?v=137';
...
import {numberedPages} from './reading-pages.js?v=137';
...
import {translatePage,language,toggleLanguage} from './language.js?v=137';
import {operationMarkup,viewNames,actionNames,totalDegreeTex} from './workbench.js?v=90';
import {createFilteredView} from './filtered-view.js?v=137';
import {createPageEvolution} from './page-evolution.js?v=137';
...
const formulas=(fs,concepts=[],number='',module='',step=0)=>numberedPages(module,step,fs.length).map((page,index)=>{
 ...
 const content=page.indices.map(i=>{
  ...
  if(module==='converge'&&step===4&&(i<=7||i===14||i===15))return leraySetup({math,t:ui,page:i-1})+formula;
