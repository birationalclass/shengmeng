...
export const lessons=[
 ...
 {title:'E₀',tag:'THE ZEROTH PAGE',f:[t`E_0^{p,q}\cong K^{p,q}`,t`(E_0^{p,\bullet},d_0)\cong(K^{p,\bullet},\delta_2)`],text:'列滤过的第零页自然同构于纵向复形。',note:'',proof:''},
 {title:'谱序列',tag:'SPECTRAL SEQUENCE',f:[t`\{(E_r^{p,q},d_r^{p,q})\}_{r\ge0}`,t`d_r^{p+r,q-r+1}\circ d_r^{p,q}=0`,t`E_{r+1}^{p,q}\cong H^{p,q}(E_r,d_r)`],text:'谱序列包含全部页、微分及逐页上同调的结构同构。',note:'',proof:''},
