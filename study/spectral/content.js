...
export const convergence=[
 ...
 {title:'收敛',f:[t`E_r^{p,q}\Longrightarrow H^{p+q}`,t`\begin{gathered}E_r^{p,q}\Longrightarrow H^{p+q}(C^\bullet,D)\\[.65em]E_\infty^{p,q}\cong\operatorname{Gr}_F^pH^{p+q}(C^\bullet,D)\end{gathered}`,t`E_{r_0}^{p,q}\Longrightarrow H^{p+q}`,t`\begin{gathered}d_s=0\quad(\forall s\ge r_0)\\[.65em]\Longrightarrow\quad E_{r_0}^{p,q}\cong E_\infty^{p,q}\end{gathered}`],text:'收敛的定义、总复形的收敛性质、起始页记号与退化。',note:'',proof:''}
];
