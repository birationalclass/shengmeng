...
import {lerayContent} from './leray.js?v=150';
...
export const convergence=[
 ...
 {title:'收敛定义',f:[t`\begin{gathered}\{(E_r^{\bullet,\bullet},d_r)\}_{r\ge0}\\[.3em]\Longrightarrow H^\bullet(C^\bullet,D)\end{gathered}`,firstQuadrantFormula,t`E_{r_0}^{p,q}\Longrightarrow H^{p+q}`,t`d_s=0\quad(\forall s\ge r_0)`,singleLineFormula],text:'收敛的定义、总复形的收敛性质、起始页记号与退化。',note:'',proof:''}
];
